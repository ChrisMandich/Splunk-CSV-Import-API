function Set-SplunkFieldAlias{
    <#
        ...
        .EXAMPLE
            Set-SplunkFieldAlias -Credential $creds -SplunkApp "search" -Value @{test1="field1";} -Name "cim_v1" -Sourcetype "syslog"
        #>
        [CmdletBinding()]
        [OutputType([psobject])]
        param (
        ...
        process {
            ...
            # The Data Payload is formatted in the following structure: "name=<Name>;stanza=<Sourcetype>;alias.test1=test2"
